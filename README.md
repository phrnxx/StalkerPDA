...
│   ├── GoogleTasksAPI.cs           // Моніторинг програмного контексту (плани/завдання)
...
│   │   ├── ChatFragment.cs         // Модуль відображення мережевої активності
│   │   ├── NewsFragment.cs         // Стрічка динамічного контенту
│   │   └── LoreListFragment.cs     // Навігація по базі знань
│   └── Adapters/                   // Трансформатори даних у візуальні елементи
│       ├── ChatAdapter.cs          
│       ├── NewsAdapter.cs          
│       └── QuestAdapter.cs         
│
├── MainActivity.cs                 // Головний координатор життєвого циклу програми
└── App.cs                          // Точка глобальної ініціалізації сервісів
